...
export class BlackjackGame {
  ...
  cacheElements() {
    this.ui = {
      lobby: document.getElementById("blackjackLobby"),
      room: document.getElementById("blackjackRoom"),
      roomId: document.getElementById("blackjackRoomId"),
      roomName: document.getElementById("blackjackRoomName"),
      roomPublic: document.getElementById("blackjackPublic"),
      searchId: document.getElementById("blackjackSearchId"),
      createBtn: document.getElementById("blackjackCreate"),
      refreshBtn: document.getElementById("blackjackRefresh"),
      rooms: document.getElementById("blackjackRooms"),
      invite: document.getElementById("blackjackInvite"),
      copyInvite: document.getElementById("blackjackCopy"),
      leaveBtn: document.getElementById("blackjackLeave"),
      dealer: document.getElementById("blackjackDealer"),
      dealerTotal: document.getElementById("blackjackDealerTotal"),
      players: document.getElementById("blackjackPlayers"),
      startBtn: document.getElementById("blackjackStart"),
      hitBtn: document.getElementById("blackjackHit"),
      standBtn: document.getElementById("blackjackStand"),
      doubleBtn: document.getElementById("blackjackDouble"),
      splitBtn: document.getElementById("blackjackSplit"),
      betRow: document.querySelector("#blackjackRoom .multi-bet-row"),
      betAmount: document.getElementById("blackjackBetAmount"),
      betButtons: document.querySelectorAll("#blackjack .multi-bet-buttons .chip"),
      betClear: document.getElementById("blackjackBetClear"),
      status: document.getElementById("blackjackStatus"),
      connecting: document.getElementById("blackjackConnecting"),
    };
  }
